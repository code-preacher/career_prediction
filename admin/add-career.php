                                     ...
                                     <div class="row p-t-20">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                  ...
                                                  <input type="text" name="result" placeholder="Career Result" class="form-control" required="required" >
                                                     </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                  ...
                                                  <input type="text" name="advice" placeholder="Career Advice" class="form-control" required="required" >
                                                     </div>
                                            </div>

                                            <div class="offset-sm-4 col-md-10">
                                                        <button type="submit" class="btn btn-success" name="sub"> <i class="ti-plus"></i> Add Data</button>
